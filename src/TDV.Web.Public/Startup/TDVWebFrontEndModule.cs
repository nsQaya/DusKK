...
namespace TDV.Web.Public.Startup
{
    [DependsOn(
        typeof(TDVWebCoreModule)
    )]
    public class TDVWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public TDVWebFrontEndModule(IWebHostEnvironment env, TDVEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TDVWebFrontEndModule).GetAssembly());
        }
    }
}
