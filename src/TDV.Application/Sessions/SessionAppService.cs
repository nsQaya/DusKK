...
{
    public class SessionAppService : TDVAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = TDVConsts.Currency,
                        CurrencySign = TDVConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = TDVConsts.AllowTenantsToChangeEmailSettings,
