...
using TDV.Auditing.Exporting;
using TDV.Authorization;
using TDV.Authorization.Users;
using TDV.Dto;
using TDV.EntityHistory;
using EntityHistoryHelper = TDV.EntityHistory.EntityHistoryHelper;

namespace TDV.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : TDVAppServiceBase, IAuditLogAppService
    {
