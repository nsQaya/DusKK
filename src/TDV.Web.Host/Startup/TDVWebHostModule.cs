...
using TDV.Auditing;
using TDV.Authorization.Users.Password;
using TDV.Configuration;
using TDV.EntityFrameworkCore;
using TDV.MultiTenancy;
using TDV.Web.Startup.ExternalLoginInfoProviders;
...
namespace TDV.Web.Startup
{
    ...
    public class TDVWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public TDVWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TDVWebHostModule).GetAssembly());
        }
