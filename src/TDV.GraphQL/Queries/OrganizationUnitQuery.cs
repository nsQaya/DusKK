...
using TDV.Core.Base;
using TDV.Core.Extensions;
using TDV.Dto;
using TDV.Types;

namespace TDV.Queries
{
    public class OrganizationUnitQuery : TDVQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
