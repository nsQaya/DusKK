...
namespace TDV.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : TDVServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("TDV", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
