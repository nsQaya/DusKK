...
namespace TDV.Authorization.Users
{
    ...
    public class UserManager : AbpUserManager<Role, User>
    {
        ...
        {
            return _localizationManager.GetString(TDVConsts.LocalizationSourceName, name);
        }
        ...
        public virtual async Task<UserDetail> GetDetailByIdAsync(long userId)
        {
            return await _userDetailRepository.FirstOrDefaultAsync(x => x.UserId == userId);
        }
    }
}
