...
using TDV.Authentication.TwoFactor;
using TDV.Configuration;
using TDV.EntityFrameworkCore;
using TDV.Startup;
using TDV.Web.Authentication.JwtBearer;
using TDV.Web.Common;
using TDV.Web.Configuration;
...
{
    [DependsOn(
        typeof(TDVApplicationModule),
        typeof(TDVEntityFrameworkCoreModule),
    ...
    public class TDVWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public TDVWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(TDVApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TDVWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(TDVWebCoreModule).Assembly);
        }
