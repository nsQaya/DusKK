...
namespace TDV.Web.Authentication.JwtBearer
{
    public class TDVAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public TDVAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
