...
{
    public class UserOrganizationUnitRepository : TDVRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<TDVDbContext> dbContextProvider)
