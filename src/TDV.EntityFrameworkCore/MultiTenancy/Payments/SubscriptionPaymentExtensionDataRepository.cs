...
{
    public class SubscriptionPaymentExtensionDataRepository : TDVRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<TDVDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
