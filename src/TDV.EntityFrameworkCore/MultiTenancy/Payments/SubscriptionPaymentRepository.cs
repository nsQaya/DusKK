...
using TDV.EntityFrameworkCore.Repositories;

namespace TDV.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : TDVRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<TDVDbContext> dbContextProvider)
