...
using TDV.Authentication.TwoFactor.Google;
using TDV.Authorization;
using TDV.Authorization.Accounts;
using TDV.Authorization.Accounts.Dto;
using TDV.Authorization.Delegation;
using TDV.Authorization.Impersonation;
...
using TDV.Web.Models.Account;
using TDV.Security;
using TDV.Security.Recaptcha;
using TDV.Sessions;
using TDV.Url;
using TDV.Web.Authentication.External;
using TDV.Web.Security.Recaptcha;
using TDV.Web.Session;
using TDV.Web.Views.Shared.Components.TenantChange;
...
{
    public class AccountController : TDVControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(TDVConsts.DateTimeOffsetFormat));
