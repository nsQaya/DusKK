...
(function () {
    $(function () {
        ...
        var _createMassNotificationModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Portal/Notifications/CreateMassNotificationModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/Notifications/_CreateMassNotificationModal.js',
