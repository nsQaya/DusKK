(function ($) {
    app.modals.CreateMassNotificationModal = function () {
        ...
        var _userLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Portal/Notifications/UserLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/Notifications/_UserLookupTableModal.js',
            modalClass: 'UserLookupTableModal',
        });

        var _organizationUnitLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Portal/Notifications/OrganizationUnitLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/Notifications/_OrganizationUnitLookupTableModal.js',
        ...
        $('#CreateMassNotificationModal_TargetNotifiers').change(function () {
            ...
            var isSMSSelected = selectedTargetNotifiers.indexOf("TDV.Notifications.SmsRealTimeNotifier") >= 0;
