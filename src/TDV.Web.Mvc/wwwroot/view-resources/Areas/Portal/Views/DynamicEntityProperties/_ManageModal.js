(function () {
  app.modals.ManageDynamicEntityPropertyModal = function () {
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Portal/DynamicEntityProperty/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/DynamicEntityProperties/_CreateModal.js',
