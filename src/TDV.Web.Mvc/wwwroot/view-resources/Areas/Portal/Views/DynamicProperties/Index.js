(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Portal/DynamicProperty/CreateOrEditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/DynamicProperties/_CreateOrEditModal.js',
      modalClass: 'CreateOrEditDynamicPropertyModal',
      cssClass: 'scrollable-modal',
    });

    var _manageValuesModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Portal/DynamicProperty/ManageValuesModal',
      scriptUrl:
        abp.appPath + 'view-resources/Areas/Portal/Views/_Bundles/dynamic-properties-manage-values.min.js',
