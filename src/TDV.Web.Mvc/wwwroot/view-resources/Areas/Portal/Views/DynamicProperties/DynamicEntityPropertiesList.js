(function () {
  $(function () {
    ...
    var _selectAnEntity = new app.ModalManager({
      viewUrl: abp.appPath + 'Portal/DynamicProperty/SelectAnEntityModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/DynamicProperties/_SelectAnEntityModal.js',
    ...
    var _manageDynamicEntityPropertyModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Portal/DynamicEntityProperty/ManageModal',
      scriptUrl:
        abp.appPath + 'view-resources/Areas/Portal/Views/_Bundles/dynamic-entity-properties-manage-modal.min.js',
