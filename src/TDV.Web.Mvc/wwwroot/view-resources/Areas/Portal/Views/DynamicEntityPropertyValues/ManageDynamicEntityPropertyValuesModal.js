(function () {
  ...
  app.modals.ManageDynamicEntityPropertyValuesModal.create = function () {
    return new app.ModalManager({
      viewUrl: abp.appPath + 'Portal/DynamicEntityPropertyValue/ManageDynamicEntityPropertyValuesModal',
      scriptUrl:
        abp.appPath +
        'view-resources/Areas/Portal/Views/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal.js',
