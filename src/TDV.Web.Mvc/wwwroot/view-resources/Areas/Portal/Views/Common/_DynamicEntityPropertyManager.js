var DynamicEntityPropertyManager = (function () {
  return function () {
    ...
    let _dynamicPropertiesModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Portal/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal',
      scriptUrl:
        abp.appPath +
        'view-resources/Areas/Portal/Views/_Bundles/manage-dynamic-entity-property-values-modal.min.js',
