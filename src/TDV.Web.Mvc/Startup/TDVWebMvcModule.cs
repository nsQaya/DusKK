...
namespace TDV.Web.Startup
{
    ...
    public class TDVWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public TDVWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TDVWebMvcModule).GetAssembly());
        }
