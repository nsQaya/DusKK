...
using TDV.Identity;
using TDV.Schemas;
using TDV.Web.Common;
using TDV.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using TDV.Web.IdentityServer;
using TDV.Web.Swagger;
using Stripe;
...
using TDV.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using TDV.Web.Extensions;
using TDV.Web.MultiTenancy;
using SecurityStampValidatorCallback = TDV.Identity.SecurityStampValidatorCallback;
...
namespace TDV.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<TDVWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (TDVConsts.PreventNotExistingTenantSubdomains)
            {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "TDV API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("TDV.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "TDV API", Version = "v1"});
                ...
                var applicationXml = $"TDV.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"TDV.Web.Core.xml";
