...
using TDV.Web.Areas.Portal.Models.DynamicEntityPropertyValues;
...
namespace TDV.Web.Areas.Portal.Controllers
{
    ...
    public class DynamicEntityPropertyValuesController : TDVControllerBase
    {
        ...
        [HttpGet("/Portal/DynamicEntityPropertyValue/ManageAll/{entityFullName}/{entityId}")]
