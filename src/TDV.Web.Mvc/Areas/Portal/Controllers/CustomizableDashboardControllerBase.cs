...
using TDV.Web.Areas.Portal.Models.CustomizableDashboard;
...
{
    public abstract class CustomizableDashboardControllerBase : TDVControllerBase
    {
        ...
        public async Task<PartialViewResult> AddWidgetModal(string dashboardName, string pageId)
        {
            var availableWidgets = await DashboardCustomizationAppService.GetAllAvailableWidgetDefinitionsForPage(
                ...
                {
                    Application = TDVDashboardCustomizationConsts.Applications.Mvc,
                    PageId = pageId,
            ...
            return PartialView(
                "~/Areas/Portal/Views/Shared/Components/CustomizableDashboard/_AddWidgetModal.cshtml",
                viewModel
            );
        }
