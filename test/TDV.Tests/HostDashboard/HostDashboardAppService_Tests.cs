...
using TDV.MultiTenancy.HostDashboard;
...
namespace TDV.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(TDVDbContext context, SubscriptionPayment subscriptionPayment)
        {
